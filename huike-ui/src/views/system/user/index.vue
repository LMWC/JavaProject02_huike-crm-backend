<template>
  <div class="app-container customer-page-box">
    <el-row :gutter="20" style="margin-left:0;">
      ...
      <!--用户数据-->
      <el-col :span="20" :xs="24" style="min-height: calc(100vh - 66px);border-left:8px solid #f2f2f2;padding-left:0px;">
        <div>
    ...
    <el-dialog :title="upload.title" :visible.sync="upload.open" width="400px" append-to-body :close-on-click-modal="false">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button class="cus-reset-btn" @click="upload.open = false">取 消</el-button>
        <el-button class="cus-search-btn" @click="submitFileForm">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
