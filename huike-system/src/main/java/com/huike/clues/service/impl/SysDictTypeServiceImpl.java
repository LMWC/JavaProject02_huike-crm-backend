...
import com.huike.clues.mapper.mybatis_plus.SysDictTypePlusMapper;
 ...
 */
@Service
public class SysDictTypeServiceImpl extends ServiceImpl<SysDictTypePlusMapper, SysDictType>implements ISysDictTypeService {
	...
	@Autowired
	private SysDictDataPlusMapper dictDataPlusMapper;
	...
	public void init() {
		...
		for (SysDictType dictType : dictTypeList) {
			...
			List<SysDictData> dictDatas = dictDataPlusMapper.selectList(queryWrapper);
...
//		return dictTypeMapper.selectDictTypeAll();
	...
	public List<SysDictData> selectDictDataByType(String dictType) {
		...
		queryWrapper.orderByAsc(SysDictData::getDictSort);
		dictDatas = dictDataPlusMapper.selectList(queryWrapper);
